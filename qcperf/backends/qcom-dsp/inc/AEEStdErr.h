...
#define AEE_EMAILBOXCREATE       (AEE_EOFFSET + 0X164)   /// Mailbox create failed
#define AEE_EMAILBOXID           (AEE_EOFFSET + 0X165)   /// Bad/invalid mailbox ID

#define AEE_EQURTREGPDDUMP       (AEE_EOFFSET + 0X166)   /// QURT Register PD dump
...
#define AEE_EMAX_MMPM_CLIENTS	 (AEE_EOFFSET + 0x176)   /// MMPM Reached maximum clients per PD - obsolete
